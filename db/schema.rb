...
ActiveRecord::Schema.define(version: 20180122102313) do
  ...
  add_index "answers", ["question_id", "evaluation_id"], name: "index_answers_on_question_id_and_evaluation_id", using: :btree
